    ...
    fn default() -> Self {
        Self {
            ...
            button: ButtonBundle {
                ...
                background_color: Color::WHITE.with_alpha(0.).into(),
                ..default()
            },
        }
    }
...
fn handle_menu_btns_on_change(
    ...
    for (e, mut btn, interaction, mut bg_color, mut border_color) in btn_query.iter_mut() {
        match interaction {
            Interaction::Pressed => {
                bg_color.0 = Color::WHITE.with_alpha(0.);
            ...
            Interaction::None => {
                bg_color.0 = Color::WHITE.with_alpha(0.);
                border_color.0 = Color::WHITE.with_alpha(0.);
            }
        }
    }
}
...
fn handle_menu_btns(
    ...
    for (btn, interaction, mut bg_color) in btn_query.iter_mut() {
        if interaction == &Interaction::Hovered {
            ...
            bg_color.0 = Color::WHITE.with_alpha(0.05 * amount);
        }
    }
}
